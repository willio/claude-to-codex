...
| --- | --- | --- | --- |
| **Primary** | `c2c` (no flag) | `https://c2c.example.com/mcp` | Account 1 |
| **Backup** | `c2c --profile wiriawan-gmail` | `https://c2c-backup.example.com/mcp` | Account 2 (wiriawan@gmail.com) |
